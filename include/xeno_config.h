...
/* config */
#define CONFIG_XENO_BUILD_ARGS " '--with-pic' '--with-core=cobalt' '--enable-smp' '--disable-tls' '--enable-dlopen-libs' '--disable-clock-monotonic-raw' 'PKG_CONFIG_PATH=:/usr/xenomai/lib/pkgconfig'"
...
/* Compiler */
#define CONFIG_XENO_COMPILER "gcc version 5.4.0 20160609 (Ubuntu 5.4.0-6ubuntu1~16.04.10) "
...
/* config */
#define CONFIG_XENO_VALGRIND_API 1
...
/* config */
#define CONFIG_XENO_VERSION_NAME "Sisyphus's Boulder"

/* config */
#define CONFIG_XENO_VERSION_STRING "3.0.5"
...
#define PACKAGE_STRING "Xenomai 3.0.5"
